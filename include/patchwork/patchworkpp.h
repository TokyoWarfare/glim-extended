...
struct Params {
  ...
  Params() {
    ...
    RNR_ver_angle_thr = -15.0;  // Noise points vertical angle threshold. Downward rays of LiDAR are
                                // more likely to generate severe noise points.
    ...
    flatness_thr = {0, 0, 0, 0};   // threshold of flatness for each ring using in GLE. Those values
